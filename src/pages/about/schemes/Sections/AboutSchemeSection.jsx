        ...
        <div className="w-full mx-auto sm:max-w-2xl md:max-w-3xl lg:max-w-5xl xl:max-w-7xl">
          <div className="grid items-center gap-12 lg:grid-cols-1">
            <div className="text-center mt-12">
              <h1
                className={`mt-0 mb-16 text-2xl font-bold tracking-tight md:text-6xl xl:text-2xl text-primary ${
              ...
              <span
                className={`mt-0 mb-16 text-3xl tracking-tight text-xl sm:text-lg md:text-6xl xl:text-base text-black ${
                  isAnimated &&
              ...
              >
                ...
                impactful: to ensure that every household gains access to credit
                through the Kisan Credit Card (KCC), revolutionizing the
