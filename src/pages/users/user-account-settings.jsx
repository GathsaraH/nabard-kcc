    ...
    <div>
                        ...
                        <form className="mb-5 rounded-md border border-[#ebedf2] bg-white p-4 dark:border-[#191e3a] dark:bg-black">
                            ...
                            <div className="flex flex-col sm:flex-row">
                                ...
                                <div className="grid flex-1 grid-cols-1 gap-5 sm:grid-cols-2">
                                    ...
                                    <div className='mt-3 sm:col-span-2 flex justify-between'>
                                        <DefaultButtonComponent title="Change Password" onClick={handleModal}/>
        ...
        <form data-testid="forgot-password-form" className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            <div>
                ...
                <IconButton icon={<AiOutlineArrowRight/>} label="Submit" />
                </div>
            </div>
        </form>
          {/* modal starts here */}
