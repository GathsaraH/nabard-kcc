...
const Index = () => {
  ...
  const InputFields = [
    {
      ...
      type: 'select',
      required: false,
      heading: 'Stake Holders Details', // Heading for the first new field
      options: [
        { label: '', value: '' },
    ...
    },
    {
      ...
      type: 'text',
      required: false,
      heading: 'Stake Holders Details', // Heading for the second new field
    },
    {
      name: 'Department',
      label: 'Department',
      type: 'text',
      required: false,
      heading: 'Stake Holders Details', // Heading for the third new field
    },
    {
      name: 'Address',
      label: 'Address',
 ...
 // State for managing form hierarchy levels
  ...
  const handleCancel = () => {
    router.push('/Organizations/Stakeholders');
  };
  const handleFormChange = (updatedData) => {
    setFormData(updatedData);
  };
  const shouldShowHierarchy = formHeadings.includes('Bank Hierarchy') || formHeadings.includes('Stakeholder Hierarchy');
  const hierarchyType = formHeadings.includes('Bank Hierarchy') ? 'Bank' : 'Stakeholder';
                ...
                <div className="flex w-full">
                  <div className="w-full block rounded-lg shadow-lg bg-white">
                    ...
                    <DefaultForm
                      ...
                      headings={formHeadings}
                      inputFieldHierarchy={inputFieldHierarchy}
                      hierarchyType={hierarchyType} // Pass the hierarchyType prop
