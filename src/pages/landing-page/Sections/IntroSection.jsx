    ...
    <section className="bg-white mb-40">
      <div className="px-6 text-center md:px-12 lg:text-left">
        <div className='flex justify-center' >
          <h1 className="mt-0 mb-16 text-3xl font-bold tracking-tight md:text-6xl xl:text-2xl text-black mt-8 animate__animated animate__slideInDown">
            GharGhar KCC Abhiyan
          </h1>
        </div>
        <div className="w-100 mx-auto sm:max-w-2xl md:max-w-3xl lg:max-w-5xl xl:max-w-7xl">

          <div className="grid items-center gap-12 lg:grid-cols-2 lg:flex-col">

            <div className="hidden sm:block lg:mb-0 animate__animated animate__slideInDown">
              <Image
                height={300}
                width={300}
                src={ImgOne}
            ...
            <div className="mt-12 lg:mt-0 animate__animated animate__slideInDown">
            ...
            <div className=" lg:hidden lg:mb-0">
              <Image
                height={300}
                width={300}
                src={ImgOne}
