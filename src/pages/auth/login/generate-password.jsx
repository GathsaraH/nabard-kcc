...
import {
  GeneratePasswordApi,
  GeneratePasswordSendOtpApi,
  GeneratePasswordVerifyOtpApi,
  ...
  const PasswordGuidelinesNote = () => {
    ...
    return (
      <div className="text-left">
        <h4 className="text-xl font-semibold mb-2 ml-5">
      ...
      <div className="flex-1 p-5">
        ...
        <div className="flex justify-start">
          <div className="w-1/2">
            ...
            <DefaultInput isDisabled value={email}firstIconClassName="mb-2" label="Email ID" icon={<AiOutlineMail size={20} placeholder="Enter your email" />} />
          </div>
        </div>
        {inputErrors.method && (
          <p className="text-red-500 text-sm mt-1">{inputErrors.method}</p>
        )}
      </div>
    );
  }
  ...
  function SecondStep() {
    return (
      <div className="flex flex-col items-center mt-4 text-center">
        ...
        <br />
        {inputErrors.otp && (
          <p className="text-red-500 text-sm mt-1">{inputErrors.otp}</p>
        )}
        <br />
    ...
    return (
      <div className="flex flex-col p-5 items-center text-center">
        ...
        <div className="w-full sm:w-1/2">
          ...
          />
          {inputErrors.newPassword && !newPassword && (
            <p className="text-red-500 text-sm mt-1">
              {inputErrors.newPassword}
            </p>
          )}
          <br />
          {newPassword && areGuidelinesMatched ? (
            <></>
          ) : (
            <PasswordGuidelinesNote />
          )}
          <br />
          {areGuidelinesMatched && (
            <PasswordInput
          ...
          {inputErrors.confirmPassword && !confirmPassword && (
            <p className="text-red-500 text-sm mt-1">
    ...
    <>
      <div className="containerFull">
        ...
        <div className="white-box">
          ...
          <div
            className={`mt-20 panel m-6 w-[350px] sm:w-[50rem] shadow-2xl rounded-2xl`}
          >
            ...
            <div className="inline-block w-full">
                    ...
                    <button
                      ...
                      className={`${
                        ...
                        activeTab === 2 || activeTab === 3
                          ? "!bg-primary-light"
                          : ""
                      } bg-white  flex justify-center items-center w-14 h-14 sm:w-16 sm:h-16  rounded-full`}
                    >
                    ...
                    <button
                      ...
                      className={`${
                        activeTab === 2 || activeTab === 3
                          ? "!bg-primary text-white "
                          : "bg-[#EEEEEE]"
                      }  ${activeTab === 1 ? "!bg-gray-light" : ""} ${
                        activeTab === 3 ? "!bg-primary-light" : ""
              ...
              <div
                className={`flex ${activeTab === 1 ? "justify-center" : ""}`}
              >
                ...
                <DefaultButtonComponent
                  icon={<AiOutlineRight />}
                  className={`${
                    activeTab !== 1 ? `ltr:ml-auto rtl:mr-auto` : "mt-5"
                  }`}
                  title={
                    activeTab === 1
                      ? "Send OTP"
